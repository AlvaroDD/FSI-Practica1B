...
class Node:
    ...
    def expand(self, problem):
        ...
        return [Node(next, self, act,
                     problem.path_cost(self.path_cost, self.state, act, next),problem.h(self)+problem.path_cost(self.path_cost, self.state, act, next))
...
def acumHeur_cost_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, CAcumEstimQueue())
